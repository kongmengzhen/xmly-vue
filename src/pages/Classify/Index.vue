<template>
  <div id="app">
    <div class="index-warp" v-show="showContent">
        ...
        <div class="tab-list">
          <ul class="tab-ul">
              <routerLink               
                  ...
                  :to='"/home/"+tabitem.moduleKey'
                  :key="i" 
                  class="tab-item" 
                  @click="addActive(i)" 
                  active-class="active">{{tabitem.moduleName}}</routerLink>          
          </ul>
        </div>     
      </div>
      <main class="main" :class="(type==undefined?'tuijian':type)"> 
        <div>     
          <div>
            <router-view @handlecmp="handleC"></router-view>   
          </div>
        </div>                           
      </main>  
    </div>
